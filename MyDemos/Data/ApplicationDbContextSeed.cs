        ...
        public static async Task SeedIdentityUserAsync(UserManager<IdentityUser> usermanager)
        {
            ...
            if (user == null)
            {
                ...
                await usermanager.AddToRolesAsync(user, new string[] {
                    MyIdentityRoleNames.LibraryAdmin.ToString(),
                    MyIdentityRoleNames.LibraryMember.ToString()
                });
            }
            ...
            if (user == null)
            {
                ...
                //});
                await usermanager.AddToRoleAsync(user, MyIdentityRoleNames.LibraryMember.ToString());
            }
        }
    }
}
